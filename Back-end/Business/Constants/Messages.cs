...
namespace Business.Constants
{
    ...
    {
        internal static string PaySuccess=>"Payment Success";
        internal static string PayError=>"Payment Error";

        public static string OrderOk=> "Your order has been created";
